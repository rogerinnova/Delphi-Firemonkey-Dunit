...
FMX.Layouts, FMX.ListView.Types, FMX.Memo, FMX.ListView, FMX.TreeView,
  ISFMXImageList, FMX.ListBox, FMX.Objects;
...
procedure TMobileGUITestRunner.ErrorBoxSplitterMoved(Sender: TObject);
begin
  // Solve bugs with Delphi4 resizing with constraints
  ErrorBoxSplitter.position.y := ErrorBoxPanel.position.y-8;
  //self.Update;
...
procedure TMobileGUITestRunner.ErrorBoxPanelResize(Sender: TObject);
begin
  // Solve bugs with Delphi4 resizing with constraints
  ErrorBoxSplitter.position.y := ErrorBoxPanel.position.y-8;
end;
